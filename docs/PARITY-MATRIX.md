...
| Kalender akademik & ujian | kalender semester, UTS/UAS, kartu peserta | academic calendar + exam scheduling | partial | agenda berdasarkan periode, publikasi, deteksi konflik ruang/dosen/mahasiswa, eligibility KRS-presensi-keuangan, kartu peserta PDF, QR verifikasi, policy, audit, modal, dan migration tersedia; pengawas/daftar hadir/berita acara menyusul |
